      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="font-['Inter'] text-lg text-[#6B5D52] leading-[1.85]">
              Шесть лет они шли рука об руку: завершали учёбу, учились любить на расстоянии, мечтали об одном городе на двоих. В итоге их дороги слились в Санкт-Петербурге, а спустя год, 29 августа 2025 года, Алина без колебаний произнесла заветное «Да». Так началась новая глава их истории.
            </p>
